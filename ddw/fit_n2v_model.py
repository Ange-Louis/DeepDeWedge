...
def fit_model(
    ...
    n2v_manipulate_params: Annotated[
        str,
        typer.Option(
            callback=ast.literal_eval,
            help=f"Dictionary of parameters for the N2V part. See {inspect.getfile(LitUnet3D)} for details.",
        ),
    ],
    ...
    val_data_exists = (
        ...
        and len(os.listdir(f"{subtomo_dir}/val_subtomos/subtomo")) > 0
    )
    ...
    lit_unet = LitUnet3D(
        ...
        n2v_manipulate_params=n2v_manipulate_params,
